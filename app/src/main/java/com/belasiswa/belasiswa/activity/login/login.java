...
import com.ujuy.ahfizh.belasiswa.activity.Sql.SqliteHelper;
import com.ujuy.ahfizh.belasiswa.activity.login.User;
...
public class login extends AppCompatActivity {
    ...
    //Declaration SqliteHelper.SqliteHelper
            ...
            public void onClick(View view) {
                ...
                if (validate()) {
                    ...
                    if (currentUser != null) {
                        ...
                        //com.logindanregistersqlite.User.com.logindanregistersqlite.User Logged in Failed
    ...
    private void initCreateAccountTextView() {
        TextView textViewCreateAccount = (TextView) findViewById(R.id.tv_register);
